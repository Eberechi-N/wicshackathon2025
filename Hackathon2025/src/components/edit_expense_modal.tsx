...
export function EditExpenseModal({ expense, onClose, onSave, categories }: EditExpenseModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    e.stopPropagation()
    console.log("Submitting expense edit form:", formData)
    onSave({
      ...formData,
          ...
          >
            <div className="bg-white rounded-lg shadow-lg w-full max-w-md mx-4" onClick={(e) => e.stopPropagation()}>
              <div className="flex items-center justify-between p-4 border-b">
                <Dialog.Title className="text-xl font-semibold">Edit Expense</Dialog.Title>
